                                    ...
                                    <div class="card card-product">
                                        <div class="card-body">
                                            ...
                                            <div class="iq-product-content mt-3">
                                                ...
                                                <a href="<?= base_url('template/frontend/') ?>product/new-product.html" class="iq-product-title-link h5"><?= $row['nama_produk'] ?></a>
                                                <div class="d-flex align-items-center justify-content-between my-2">
                                                    <h6 class="m-0">
                                                        <span class="text-decoration-line-through"></span>
                                                        <span class="text-primary"><b>Rp. <?= number_format($row['harga_produk'], 0, ",", ".") ?></b> / pcs</span>
                                                    </h6>
