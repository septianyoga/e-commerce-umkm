<div class="iq-sidebar  sidebar-default ">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
        <a href="<?= base_url('admin') ?>" class="header-logo">
            ...
            <h5 class="logo-title light-logo ml-3">UMKM <small>RASA ALAMI</small></h5>
        </a>
        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="<?= $title == 'Dashboard Admin' ? 'active' : '' ?>">
                    <a href="<?= base_url('admin') ?>" class="svg-icon">
                ...
                <li class=" ">
                    ...
                    <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-list-category.html">
                                <i class="las la-minus"></i><span>List Category</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-add-category.html">
                ...
                <li class=" ">
                    ...
                    <ul id="sale" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-list-sale.html">
                                <i class="las la-minus"></i><span>List Sale</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-add-sale.html">
                ...
                <li class=" ">
                    ...
                    <ul id="purchase" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-list-purchase.html">
                                <i class="las la-minus"></i><span>List Purchases</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-add-purchase.html">
                ...
                <li class=" ">
                    ...
                    <ul id="return" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-list-returns.html">
                                <i class="las la-minus"></i><span>List Returns</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-add-return.html">
                ...
                <li class=" ">
                    ...
                    <ul id="people" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-list-customers.html">
                                <i class="las la-minus"></i><span>Customers</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-add-customers.html">
                                <i class="las la-minus"></i><span>Add Customers</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-list-users.html">
                                <i class="las la-minus"></i><span>Users</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-add-users.html">
                                <i class="las la-minus"></i><span>Add Users</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-list-suppliers.html">
                                <i class="las la-minus"></i><span>Suppliers</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/page-add-supplier.html">
                ...
                <li class="">
                    <a href="<?= base_url('template/backend/html/') ?>backend/page-report.html" class="">
                    ...
                    <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class=" ">
                            ...
                            <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>app/user-profile.html">
                                        <i class="las la-minus"></i><span>User Profile</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>app/user-add.html">
                                        <i class="las la-minus"></i><span>User Add</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>app/user-list.html">
                        ...
                        <li class=" ">
                            ...
                            <ul id="ui" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-avatars.html">
                                        <i class="las la-minus"></i><span>Avatars</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-alerts.html">
                                        <i class="las la-minus"></i><span>Alerts</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-badges.html">
                                        <i class="las la-minus"></i><span>Badges</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-breadcrumb.html">
                                        <i class="las la-minus"></i><span>Breadcrumb</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-buttons.html">
                                        <i class="las la-minus"></i><span>Buttons</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-buttons-group.html">
                                        <i class="las la-minus"></i><span>Buttons Group</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-boxshadow.html">
                                        <i class="las la-minus"></i><span>Box Shadow</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-colors.html">
                                        <i class="las la-minus"></i><span>Colors</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-cards.html">
                                        <i class="las la-minus"></i><span>Cards</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-carousel.html">
                                        <i class="las la-minus"></i><span>Carousel</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-grid.html">
                                        <i class="las la-minus"></i><span>Grid</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-helper-classes.html">
                                        <i class="las la-minus"></i><span>Helper classes</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-images.html">
                                        <i class="las la-minus"></i><span>Images</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-list-group.html">
                                        <i class="las la-minus"></i><span>list Group</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-media-object.html">
                                        <i class="las la-minus"></i><span>Media</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-modal.html">
                                        <i class="las la-minus"></i><span>Modal</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-notifications.html">
                                        <i class="las la-minus"></i><span>Notifications</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-pagination.html">
                                        <i class="las la-minus"></i><span>Pagination</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-popovers.html">
                                        <i class="las la-minus"></i><span>Popovers</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-progressbars.html">
                                        <i class="las la-minus"></i><span>Progressbars</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-typography.html">
                                        <i class="las la-minus"></i><span>Typography</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-tabs.html">
                                        <i class="las la-minus"></i><span>Tabs</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-tooltips.html">
                                        <i class="las la-minus"></i><span>Tooltips</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/ui-embed-video.html">
                        ...
                        <li class=" ">
                            ...
                            <ul id="auth" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/auth-sign-in.html">
                                        <i class="las la-minus"></i><span>Login</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/auth-sign-up.html">
                                        <i class="las la-minus"></i><span>Register</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/auth-recoverpw.html">
                                        <i class="las la-minus"></i><span>Recover Password</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/auth-confirm-mail.html">
                                        <i class="las la-minus"></i><span>Confirm Mail</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/auth-lock-screen.html">
                        ...
                        <li class="">
                            ...
                            <ul id="form" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/form-layout.html">
                                        <i class="las la-minus"></i><span class="">Form Elements</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/form-input-group.html" class="svg-icon">
                                        <i class="las la-minus"></i><span class="">Form Input</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/form-validation.html" class="svg-icon">
                                        <i class="las la-minus"></i><span class="">Form Validation</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/form-switch.html" class="svg-icon">
                                        <i class="las la-minus"></i><span class="">Form Switch</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/form-chechbox.html" class="svg-icon">
                                        <i class="las la-minus"></i><span class="">Form Checkbox</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/form-radio.html" class="svg-icon">
                                        <i class="las la-minus"></i><span class="">Form Radio</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/form-textarea.html" class="svg-icon">
                        ...
                        <li class=" ">
                            ...
                            <ul id="table" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/tables-basic.html">
                                        <i class="las la-minus"></i><span>Basic Tables</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/table-data.html">
                                        <i class="las la-minus"></i><span>Data Table</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/table-tree.html">
                        ...
                        <li class=" ">
                            ...
                            <ul id="pricing" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/pricing.html">
                                        <i class="las la-minus"></i><span>Pricing 1</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/pricing-2.html">
                        ...
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/pages-invoice.html" class="svg-icon">
                        ...
                        <li class=" ">
                            ...
                            <ul id="pages-error" class="iq-submenu collapse" data-parent="#otherpage">
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/pages-error.html">
                                        <i class="las la-minus"></i><span>Error 404</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="<?= base_url('template/backend/html/') ?>backend/pages-error-500.html">
                        ...
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/pages-blank-page.html">
                        ...
                        <li class="">
                            <a href="<?= base_url('template/backend/html/') ?>backend/pages-maintenance.html">
            ...
            <div class="card border-none">
                <div class="card-body p-0">
                    <div class="sidebarbottom-content">
                        <div class="image"><img src="<?= base_url('template/backend/html/') ?>assets/images/layouts/side-bkg.png" class="img-fluid" alt="side-bkg"></div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="<?= base_url('admin') ?>" class="header-logo">
                    ...
                    <h5 class="logo-title ml-3">UMKM <small>RASA ALAMI</small></h5>
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="search-toggle dropdown-toggle btn border add-btn" id="dropdownMenuButton02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?= base_url('template/backend/html/') ?>assets/images/small/flag-01.png" alt="img-flag" class="img-fluid image-flag mr-2">En
                            </a>
                            <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <div class="card shadow-none m-0">
                                    <div class="card-body p-3">
                                        <a class="iq-sub-card" href="#"><img src="<?= base_url('template/backend/html/') ?>assets/images/small/flag-02.png" alt="img-flag" class="img-fluid mr-2">French</a>
                                        <a class="iq-sub-card" href="#"><img src="<?= base_url('template/backend/html/') ?>assets/images/small/flag-03.png" alt="img-flag" class="img-fluid mr-2">Spanish</a>
                                        <a class="iq-sub-card" href="#"><img src="<?= base_url('template/backend/html/') ?>assets/images/small/flag-04.png" alt="img-flag" class="img-fluid mr-2">Italian</a>
                                        <a class="iq-sub-card" href="#"><img src="<?= base_url('template/backend/html/') ?>assets/images/small/flag-05.png" alt="img-flag" class="img-fluid mr-2">German</a>
                                        <a class="iq-sub-card" href="#"><img src="<?= base_url('template/backend/html/') ?>assets/images/small/flag-06.png" alt="img-flag" class="img-fluid mr-2">Japanese</a>
                                    </div>
                                </div>
                            </div>
                        </li>
